...
public class Time {
     ...
     * @param lowerHairCut
     *      The lower bound of the time it takes for a haircut.
     * @param upperHairCut
     *      The upper bound of the time it takes for a haircut.
     * @param lowerDissatisfied
     *      The lower bound of the time it takes for a dissatisfied customer to return.
     * @param upperDissatisfied
     *      The upper bound of the time it takes for a dissatisfied customer to return.
     */
     ...
     * @return
     *       The next time for an arrival event as a double.
     */
     ...
     * @return
     *      The next time for a dissatisfied customer arrival.
     */
